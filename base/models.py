...
class Worker(models.Model):
    ...
    active = models.BooleanField('Активен', null=True, blank=True, default=True)
...
class Ticket(models.Model):
    ...
    ticket_object = models.ForeignKey(Object, on_delete=models.CASCADE, verbose_name='Объект заявки', null=True, blank=True)
    ...
    ticket_build_housing = models.CharField('Корпус', max_length=10, blank=True, null=True)
    ticket_par = models.IntegerField('Парадная', blank=True, null=True)
    ticket_obj_type = models.ForeignKey(ObjType, on_delete=models.DO_NOTHING, verbose_name='Тип лифта', blank=True, null=True)
    ticket_type = models.ForeignKey(TicketType, on_delete=models.DO_NOTHING, verbose_name='Тип заявки', blank=True, null=True)
    ticket_content = models.CharField('Содержание', max_length=1000, blank=True)
    ticket_status = models.ForeignKey(TicketStatus, on_delete=models.DO_NOTHING, default=1, verbose_name='Статус')
    ticket_duration = models.DurationField('Время простоя', blank=True, null=True)
